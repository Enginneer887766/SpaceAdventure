...
var welldoneSound,winSound,loseSound,restartSound,readySound;
var loseVar = 0;
...
welldoneSound = loadSound('WellDone.mp3');
winSound = loadSound('YouWin.mp3');
loseSound= loadSound('YouLose.mp3');
restartSound = loadSound('Restart.mp3');
readySound = loadSound('getready.mp3');
...
function spawnEnemy2() {
  ...
  if (frameCount % 30 === 0) {
    ...
    if (rand === 1) {
      enemy = createSprite(0,random(50,550),50,50);
      enemy.setVelocity(+15,0);
      enemy.addImage(rightA);
      enemy.scale=(0.2);
      ;
    }
    else if(rand === 2){
      enemy = createSprite(1000,random(50,550),50,50);
      enemy.setVelocity(-15,0);
      enemy.addImage(leftA);
      enemy.scale=(0.2);
      ...
      enemy = createSprite(random(50,850),0,50,50);
      ...
      enemy = createSprite(random(50,850),600,50,50);
      enemy.setVelocity(0,-15);
      enemy.addImage(upA);
      enemy.scale=(0.2);
